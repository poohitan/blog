...
$mailto = 'poohitan@gmail.com' ;
$subject = "Додано нову подію" ;
$formurl = "http://poohitan.com/cake/" ;
$thankyouurl = "http://poohitan.com/cake/" ;
$errorurl = "http://poohitan.com/cake/notsent.php" ;
...
$messageproper =
	"Цей лист відправлено з:" . $content_nl .
	"$http_referrer" . $content_nl .
	"------------------------------------------------------------" . $content_nl .
	"Е-пошта відправника: $email" . $content_nl .
	"Рік події: $fullname" . $content_nl .
	"Опис події:" . $content_nl . $content_nl .
