$(function() {
    ...
    function renderWidget(upcomingEvents, pastEvents) {
        ...
        var upcomingEventsButton = $('<a href="#upcoming-events" class="tumbler" id="upcoming-events"></a>');
        upcomingEventsButton.html('Upcoming events');
        var pastEventsButton = $('<a href="#past-events" class="tumbler" id="past-events"></a>');
        pastEventsButton.html('Past events');
    ...
    function renderEvent(event) {
        ...
        if (!isPastEvent(event)) {
            ...
            ticketsItem.html('<a href=' + event.ticket_url + 
                ...
                ticketsItem.html('Not available yet');
            }
            eventRow.append(ticketsItem);
            console.log(event.title + ' ' + event.ticket_status);
        }
    ...
    function setCSS() {
        $('#bands-in-town-widget a').css('color', '#0CC9F1');
        $('#bands-in-town-widget a:visited').css('color', '#0CC9F1');
